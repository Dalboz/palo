...
#ifndef OLAP_JOB_INFO_CUBE_H
#define OLAP_JOB_INFO_CUBE_H 1
...
class SERVER_CLASS JobInfoCube : public SystemCube {
public:
	////////////////////////////////////////////////////////////////////////////////
	...
	JobInfoCube(PDatabase db, const string& name, const IdentifiersType* dimensions);

	JobInfoCube(const JobInfoCube &c) : SystemCube(c) {}
