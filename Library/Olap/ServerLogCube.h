...
#ifndef OLAP_SERVER_LOG_CUBE_H
#define OLAP_SERVER_LOG_CUBE_H 1
...
class SERVER_CLASS ServerLogCube : public SystemCube {
public:
	////////////////////////////////////////////////////////////////////////////////
	...
	ServerLogCube(PDatabase db, const string& name, const IdentifiersType* dimensions);
