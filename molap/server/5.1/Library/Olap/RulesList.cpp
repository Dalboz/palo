...
RuleList::RuleList(const RuleList& l) :
	CommitableList(l)
{
}

PCommitableList RuleList::createnew(const CommitableList& l) const
{
	return PCommitableList(new RuleList(dynamic_cast<const RuleList&>(l)));
}
