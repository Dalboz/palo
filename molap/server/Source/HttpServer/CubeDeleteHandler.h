...
#ifndef HTTP_SERVER_CUBE_DELETE_HANDLER_H
#define HTTP_SERVER_CUBE_DELETE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS CubeDeleteHandler : public PaloHttpHandler {
  public:
    CubeDeleteHandler (Server * server) 
