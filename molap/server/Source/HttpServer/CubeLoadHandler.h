...
#ifndef HTTP_SERVER_CUBE_LOAD_HANDLER_H
#define HTTP_SERVER_CUBE_LOAD_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS CubeLoadHandler : public PaloHttpHandler {
    
  public:
    CubeLoadHandler (Server * server) 
