...
#ifndef HTTP_SERVER_DATABASE_UNLOAD_HANDLER_H
#define HTTP_SERVER_DATABASE_UNLOAD_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DatabaseUnloadHandler : public PaloHttpHandler {
    
  public:
    DatabaseUnloadHandler (Server * server) 
