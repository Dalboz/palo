...
#ifndef HTTP_SERVER_DIMENSION_DELETE_HANDLER_H
#define HTTP_SERVER_DIMENSION_DELETE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DimensionDeleteHandler : public PaloHttpHandler {
  public:
    DimensionDeleteHandler (Server * server) 
