...
#ifndef HTTP_SERVER_CUBE_INFO_HANDLER_H
#define HTTP_SERVER_CUBE_INFO_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS CubeInfoHandler : public PaloHttpHandler {
  public:
    CubeInfoHandler (Server * server) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      Cube * cube         = findCube(database, request, user);      
