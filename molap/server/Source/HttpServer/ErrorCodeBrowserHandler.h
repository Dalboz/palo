////////////////////////////////////////////////////////////////////////////////
/// @brief error code browser handler
///
/// @file
///
...
#ifndef HTTP_SERVER_ERROR_CODE_BROWSER_HANDLER_H
#define HTTP_SERVER_ERROR_CODE_BROWSER_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS ErrorCodeBrowserHandler : public PaloHttpBrowserHandler {
  public:
    ErrorCodeBrowserHandler (Server * server, const string& path) 
