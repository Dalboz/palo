...
#ifndef HTTP_SERVER_ELEMENT_BROWSER_HANDLER_H
#define HTTP_SERVER_ELEMENT_BROWSER_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS ElementBrowserHandler : public PaloHttpBrowserHandler {
  public:
    ElementBrowserHandler (Server * server, const string &path) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      Element* element     = findElement(dimension, request, user);
