...
#ifndef HTTP_SERVER_SERVER_DATABASES_HANDLER_H
#define HTTP_SERVER_SERVER_DATABASES_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS ServerDatabasesHandler : public PaloHttpHandler {
  public:
    ServerDatabasesHandler (Server * server) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      return generateDatabasesResponse(server, &databases, showNormal, showSystem);
    }
  };
