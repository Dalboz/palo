...
#ifndef HTTP_SERVER_DIMENSION_CREATE_HANDLER_H
#define HTTP_SERVER_DIMENSION_CREATE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DimensionCreateHandler : public PaloHttpHandler {
  public:
    DimensionCreateHandler (Server * server) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      Dimension* dimension = database->addDimension(name, user, isInfo);
