...
#ifndef HTTP_SERVER_CUBE_SAVE_HANDLER_H
#define HTTP_SERVER_CUBE_SAVE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS CubeSaveHandler : public PaloHttpHandler {
    
  public:
    CubeSaveHandler (Server * server) 
