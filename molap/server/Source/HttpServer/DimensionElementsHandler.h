...
#ifndef HTTP_SERVER_DIMENSION_ELEMENTS_HANDLER_H
#define HTTP_SERVER_DIMENSION_ELEMENTS_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DimensionElementsHandler : public PaloHttpHandler {
  public:
    DimensionElementsHandler (Server * server) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      return generateElementsResponse(dimension, &elements);
    }
  };
