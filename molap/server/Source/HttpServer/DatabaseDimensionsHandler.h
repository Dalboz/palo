...
#ifndef HTTP_SERVER_DATABASE_DIMENSIONS_HANDLER_H
#define HTTP_SERVER_DATABASE_DIMENSIONS_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DatabaseDimensionsHandler : public PaloHttpHandler {
  public:
    DatabaseDimensionsHandler (Server * server) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      return generateDimensionsResponse(database, &dimensions, showNormal, showSystem, showAttribute, showInfo);
    }
  };
