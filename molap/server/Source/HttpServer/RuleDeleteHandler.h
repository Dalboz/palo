...
#ifndef HTTP_SERVER_RULE_DELETE_HANDLER_H
#define HTTP_SERVER_RULE_DELETE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS RuleDeleteHandler : public PaloHttpHandler {
    
  public:
    RuleDeleteHandler (Server * server) 
