...
#ifndef HTTP_SERVER_CUBE_RENAME_HANDLER_H
#define HTTP_SERVER_CUBE_RENAME_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS CubeRenameHandler : public PaloHttpHandler {
  public:
    CubeRenameHandler (Server * server) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) {
      ...
      database->renameCube(cube, newName, user);
