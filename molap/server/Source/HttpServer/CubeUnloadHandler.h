...
#ifndef HTTP_SERVER_CUBE_UNLOAD_HANDLER_H
#define HTTP_SERVER_CUBE_UNLOAD_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS CubeUnloadHandler : public PaloHttpHandler {
    
  public:
    CubeUnloadHandler (Server * server) 
