...
#ifndef HTTP_SERVER_ELEMENT_BROWSER_DOCUMENTATION_H
#define HTTP_SERVER_ELEMENT_BROWSER_DOCUMENTATION_H 1
...
namespace palo {
  ...
  public:
    ...
    ElementBrowserDocumentation (Database * database, Dimension * dimension, Element * element, const string& message);
  };
