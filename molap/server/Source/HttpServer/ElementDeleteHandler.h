...
#ifndef HTTP_SERVER_ELEMENT_DELETE_HANDLER_H
#define HTTP_SERVER_ELEMENT_DELETE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS ElementDeleteHandler : public PaloHttpHandler {
  public:
    ElementDeleteHandler (Server * server) 
