...
#ifndef HTTP_SERVER_DATABASE_LOAD_HANDLER_H
#define HTTP_SERVER_DATABASE_LOAD_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DatabaseLoadHandler : public PaloHttpHandler {
    
  public:
    DatabaseLoadHandler (Server * server) 
