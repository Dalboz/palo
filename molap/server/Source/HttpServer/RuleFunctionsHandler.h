////////////////////////////////////////////////////////////////////////////////
/// @brief rule function list handler
///
/// @file
///
...
#ifndef HTTP_SERVER_RULE_FUNCTIONS_HANDLER_H
#define HTTP_SERVER_RULE_FUNCTIONS_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS RuleFunctionsHandler : public PaloHttpHandler {
    
  public:
    RuleFunctionsHandler (Server * server, const string& directory)
      : PaloHttpHandler(server), api(directory) {
    }
  ...
  private:
    void loadCategories () {
      FileReader fr(FileName(api, "categories", "csv"));
      fr.openFile();
    ...
    void loadShortDescription () {
      FileReader fr(FileName(api, "short-description", "csv"));
      fr.openFile();
    ...
    void loadLongDescription () {
      FileReader fr(FileName(api, "long-description", "csv"));
      fr.openFile();
