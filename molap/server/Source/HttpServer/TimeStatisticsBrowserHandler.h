...
#ifndef HTTP_SERVER_TIME_STATISTICS_BROWSER_HANDLER_H
#define HTTP_SERVER_TIME_STATISTICS_BROWSER_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS TimeStatisticsBrowserHandler : public PaloHttpBrowserHandler {
  public:
    TimeStatisticsBrowserHandler (Server * server, const string &path) 
  ...
  public:
    HttpResponse * handlePaloRequest (const HttpRequest * request) { 
      ...
      HtmlFormatter hd(templatePath + "/browser_time_statistics.tmpl");
