...
#ifndef HTTP_SERVER_DATABASE_DELETE_HANDLER_H
#define HTTP_SERVER_DATABASE_DELETE_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS DatabaseDeleteHandler : public PaloHttpHandler {
  public:
    DatabaseDeleteHandler (Server * server) 
