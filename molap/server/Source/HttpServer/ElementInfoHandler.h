...
#ifndef HTTP_SERVER_ELEMENT_INFO_HANDLER_H
#define HTTP_SERVER_ELEMENT_INFO_HANDLER_H 1
...
namespace palo {
  ...
  class SERVER_CLASS ElementInfoHandler : public PaloHttpHandler {
  public:
    ElementInfoHandler (Server * server) 
