...
namespace palo {
  ...
  class HTTPS_CLASS PaloHttpsServer : public HttpServer {
  ...
  public:
    ...
    PaloHttpsServer (Server*, Scheduler*, SSL_CTX*);
  ...
  public:
    ...
    void handleClientHangup (HttpsServerTask * task);
    void handleShutdown ();
