...
namespace palo {
  ...
  private:
    ...
    enum State_t {
      STATE_ARGUMENTS_EXHAUSTED,
      STATE_LOAD_ARGUMENT,
      STATE_LOAD_VALUE,
      STATE_PROCESS_ARGUMENT,
      STATE_PROCESS_CURRENT_OPTION,
      STATE_PROCESS_LONG_OPTION,
      STATE_PROCESS_SHORT_OPTION,
      STATE_PROCESS_SHORT_OPTION_NO_GUESS,
      STATE_RETURN_ERROR,
      STATE_RETURN_LIST_OPTION,
      STATE_RETURN_POSITIONAL,
      STATE_RETURN_VALUE
    };
