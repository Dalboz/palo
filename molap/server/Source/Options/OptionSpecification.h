...
namespace palo {
  ...
  public:
    ...
    OptionSpecification (const OptionSpecification & copy)
      : hidden(copy.hidden), optionChar(copy.optionChar), longOption(copy.longOption),
        valueSpecification(copy.valueSpecification), valueDescription(copy.valueDescription),
