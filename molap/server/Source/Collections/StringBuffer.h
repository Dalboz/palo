...
#define LENSTR(a) (sizeof(__STRING_ ## a) - 1)
  ...
  struct StringBuffer {
    ...
    void appendInteger (uint8_t attr) {
      ...
      if (100L <= attr) { appendChar0((char)((attr / 100L) % 10 + '0')); }
      if ( 10L <= attr) { appendChar0((char)((attr /  10L) % 10 + '0')); }
    ...
    void appendInteger (uint32_t attr) {
      ...
      if (1000000000L <= attr) { appendChar0((char)((attr / 1000000000L) % 10 + '0')); }
      if ( 100000000L <= attr) { appendChar0((char)((attr /  100000000L) % 10 + '0')); }
      if (  10000000L <= attr) { appendChar0((char)((attr /   10000000L) % 10 + '0')); }
      if (   1000000L <= attr) { appendChar0((char)((attr /    1000000L) % 10 + '0')); }
      if (    100000L <= attr) { appendChar0((char)((attr /     100000L) % 10 + '0')); }
      if (     10000L <= attr) { appendChar0((char)((attr /      10000L) % 10 + '0')); }
      if (      1000L <= attr) { appendChar0((char)((attr /       1000L) % 10 + '0')); }
      if (       100L <= attr) { appendChar0((char)((attr /        100L) % 10 + '0')); }
      if (        10L <= attr) { appendChar0((char)((attr /         10L) % 10 + '0')); }
    ...
    void appendDecimal (double attr) {
      ...
      char b [ 1024 ];
      size_t written = snprintf(b, sizeof(b) - 1, "%.15f", attr);
