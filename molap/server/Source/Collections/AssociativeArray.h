...
#ifndef COLLECTIONS_ASSOCIATIVE_ARRAY_H
#define COLLECTIONS_ASSOCIATIVE_ARRAY_H 1
...
namespace palo {
  ...
  public:
    ...
    bool addElement (const KEY& key, const ELEMENT& element, bool overwrite = true) {
