...
namespace palo {
  ...
  static Condition * descendCompare (COMPARE op, const char * & ptr, const char * end) {
    ...
    if (*ptr == '"') {
      ...
      switch (op) {
        case OP_LT:  return new UnaryCondition< less<double>, less<string> >(value);
        case OP_LE:  return new UnaryCondition< less_equal<double>, less_equal<string> >(value);
        case OP_EQ:  return new UnaryCondition< equal_to<double>, equal_to<string> >(value);
        case OP_GT:  return new UnaryCondition< greater<double>, greater<string> >(value);
        case OP_GE:  return new UnaryCondition< greater_equal<double>, greater_equal<string> >(value);
        case OP_NEQ: return new UnaryCondition< not_equal_to<double>, not_equal_to<string> >(value);
      }
    }
    else {
      ...
      switch (op) {
        case OP_LT:  return new UnaryCondition< less<double>, less<string> >(d);
        case OP_LE:  return new UnaryCondition< less_equal<double>, less_equal<string> >(d);
        case OP_EQ:  return new UnaryCondition< equal_to<double>, equal_to<string> >(d);
        case OP_GT:  return new UnaryCondition< greater<double>, greater<string> >(d);
        case OP_GE:  return new UnaryCondition< greater_equal<double>, greater_equal<string> >(d);
        case OP_NEQ: return new UnaryCondition< not_equal_to<double>, not_equal_to<string> >(d);
      }
    }
