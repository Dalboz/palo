...
#ifndef INPUT_OUTPUT_STATISTICS_DOCUMENTATION_H
#define INPUT_OUTPUT_STATISTICS_DOCUMENTATION_H 1
...
namespace palo {
  ...
  private:
    void generateTimings (vector<string>& path,
                          map<string, Statistics::Timing> timings,
