...
#ifndef INPUT_OUTPUT_READ_WRITE_TASK_H
#define INPUT_OUTPUT_READ_WRITE_TASK_H 1
...
namespace palo {
  ...
  class SERVER_CLASS ReadWriteTask : virtual public ReadTask, virtual public WriteTask {
  public:
