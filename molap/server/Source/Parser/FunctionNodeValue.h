////////////////////////////////////////////////////////////////////////////////
/// @brief parser function node value
///
/// @file
///
...
#ifndef PARSER_FUNCTION_NODE_VALUE_H
#define PARSER_FUNCTION_NODE_VALUE_H 1
...
namespace palo {
  ...
  class SERVER_CLASS FunctionNodeValue : public FunctionNode {
      
    public:
      static FunctionNode* createNode (const string& name, vector<Node*> *params) {
        return new FunctionNodeValue(name, params);
      }

    public:
      FunctionNodeValue () : FunctionNode() {
      }

      FunctionNodeValue (const string& name,  vector<Node*> *params) : FunctionNode(name, params) {
      }

      Node * clone () {
        FunctionNodeValue * cloned = new FunctionNodeValue(name, cloneParameters());
