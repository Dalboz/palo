////////////////////////////////////////////////////////////////////////////////
/// @brief parser function node palo eparentcount
///
/// @file
///
...
#ifndef PARSER_FUNCTION_NODE_PALO_EPARENTCOUNT_H
#define PARSER_FUNCTION_NODE_PALO_EPARENTCOUNT_H 1
...
namespace palo {
  ...
  class SERVER_CLASS FunctionNodePaloEparentcount : public FunctionNodePalo {

    public:
      static FunctionNode* createNode (const string& name, vector<Node*> *params) {
        return new FunctionNodePaloEparentcount(name, params);
      }
      
    public:
      FunctionNodePaloEparentcount () : FunctionNodePalo() {
      }

      FunctionNodePaloEparentcount (const string& name,  vector<Node*> *params) : FunctionNodePalo(name, params) {
      }

      Node * clone () {
        FunctionNodePaloEparentcount * cloned = new FunctionNodePaloEparentcount(name, cloneParameters());
      ...
      RuleValueType getValue (CellPath* cellPath, User* user, bool* isCachable, set< pair<Rule*, IdentifiersType> >* ruleHistory) {
        ...
        if (valid) {
          ...
          if (element) {
            ...
            result.doubleValue = (double) parents->size();
            return result;
          }
        }
