...
namespace palo {
  const string AttributesCube::PREFIX_ATTRIBUTE_CUBE = "#_";
    
    
  AttributesCube::AttributesCube (IdentifierType identifier,
                const string& name,
                Database* database,
  ...
  void AttributesCube::saveCubeType (FileWriter* file) {
