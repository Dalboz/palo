...
#ifndef OLAP_CACHE_CONSOLIDATIONS_STORAGE_H
#define OLAP_CACHE_CONSOLIDATIONS_STORAGE_H 1
...
#include "Olap/CacheConsolidationsPage.h"
...
namespace palo {
  ...
  class SERVER_CLASS CacheConsolidationsStorage: public CacheStorage {
  ...
  public:
    ...
    CacheConsolidationsStorage (const vector<size_t>* sizeDimensions, size_t valueSize);

    ////////////////////////////////////////////////////////////////////////////////
    /// @brief Remove a cache storage
    ////////////////////////////////////////////////////////////////////////////////

    ~CacheConsolidationsStorage ();
  ...
  private:
    ...
    static void registerCache(CacheConsolidationsStorage* cache) {
      cacheSet.insert(cache);
    }
    
    static void removeCache(CacheConsolidationsStorage* cache) {
