...
#ifndef OLAP_CACHE_RULES_PAGE_H
#define OLAP_CACHE_RULES_PAGE_H 1
...
namespace palo {
  ...
  /// 
  /// A cache page stores/caches the consolidated cell data into a fixed memory size.
  ////////////////////////////////////////////////////////////////////////////////

  class SERVER_CLASS CacheRulesPage : public CachePage {
  ...
  public:
    ...
    CacheRulesPage (CubeIndex* index,
              size_t keySize,
              size_t valueSize,
